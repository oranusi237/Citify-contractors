...
export default function ServicesCard({ cardIcon, description, serviceName }) {
    return (
        <Box>
            <Stack flex={1} height="295px" bg="white" borderRadius={8} padding={"20px"} boxShadow={"-1px 1px 5px 1px rgba(192,198,165,0.75)"} justify="space-around" align="center" textAlign="center" width={["90%", "90%", "300px"]}>
