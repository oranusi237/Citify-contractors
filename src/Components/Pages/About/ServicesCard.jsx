    ...
    return (
        <Box>
            <HoverAnimationContainer children={
                <Stack minH="330px" h={"max-content"} bg="white" borderRadius={8} padding={"20px"} boxShadow={"-1px 1px 5px 1px rgba(192,198,165,0.75)"} justify="space-around" align="center" textAlign="center" width={["90%", "90%", "280px"]}>
